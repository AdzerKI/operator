...
func (in *HTTPConfig) DeepCopyInto(out *HTTPConfig) {
	*out = *in
	...
	if in.HTTPHeaders != nil {
		...
		*out = make(map[string]HTTPHeaderConfig, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPHeaderConfig) DeepCopyInto(out *HTTPHeaderConfig) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPHeaderConfig.
func (in *HTTPHeaderConfig) DeepCopy() *HTTPHeaderConfig {
	if in == nil {
		return nil
	}
	out := new(HTTPHeaderConfig)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMAccessClaim) DeepCopyInto(out *VMAccessClaim) {
	*out = *in
	if in.MetricsExtraFilters != nil {
		in, out := &in.MetricsExtraFilters, &out.MetricsExtraFilters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.MetricsExtraLabels != nil {
		in, out := &in.MetricsExtraLabels, &out.MetricsExtraLabels
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.LogsExtraFilters != nil {
		in, out := &in.LogsExtraFilters, &out.LogsExtraFilters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.LogsExtraStreamFilters != nil {
		in, out := &in.LogsExtraStreamFilters, &out.LogsExtraStreamFilters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMAccessClaim.
func (in *VMAccessClaim) DeepCopy() *VMAccessClaim {
	if in == nil {
		return nil
	}
	out := new(VMAccessClaim)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMClusterPool) DeepCopyInto(out *VMClusterPool) {
	*out = *in
	if in.VMStorage != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMClusterPool.
func (in *VMClusterPool) DeepCopy() *VMClusterPool {
	if in == nil {
		return nil
	}
	out := new(VMClusterPool)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VMClusterSpec) DeepCopyInto(out *VMClusterSpec) {
	*out = *in
	in.VMClusterSpecBase.DeepCopyInto(&out.VMClusterSpecBase)
	if in.Pools != nil {
		in, out := &in.Pools, &out.Pools
		*out = make([]VMClusterPool, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMClusterSpecBase) DeepCopyInto(out *VMClusterSpecBase) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMClusterSpecBase.
func (in *VMClusterSpecBase) DeepCopy() *VMClusterSpecBase {
	if in == nil {
		return nil
	}
	out := new(VMClusterSpecBase)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VMUserJWT) DeepCopyInto(out *VMUserJWT) {
	*out = *in
	...
	if in.DefaultVMAccessClaim != nil {
		in, out := &in.DefaultVMAccessClaim, &out.DefaultVMAccessClaim
		*out = new(VMAccessClaim)
		(*in).DeepCopyInto(*out)
	}
}
