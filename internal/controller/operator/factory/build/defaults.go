...
// and httpListenAddr is not already set via ExtraArgs.
// It also migrates the deprecated UseProxyProtocol flag into the default listener.
func addDefaultHTTPListeners(common *vmv1beta1.CommonAppsParams, useProxyProtocol bool, httpListeners *[]vmv1beta1.HTTPListener) {
	...
	if _, hasOverride := common.ExtraArgs["httpListenAddr"]; hasOverride {
		return
	}
