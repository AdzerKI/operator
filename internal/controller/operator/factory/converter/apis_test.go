...
func TestConvertRelabelConfig(t *testing.T) {
	...
	f := func(o opts) {
		t.Helper()
		ctx := context.TODO()
		got := ConvertRelabelConfig(ctx, o.prc)
		assert.Equal(t, got, o.want)
	}
...
func TestConvertEndpoint(t *testing.T) {
	...
	f := func(o opts) {
		t.Helper()
		ctx := context.TODO()
		assert.Equal(t, convertEndpoint(ctx, o.pe), o.want)
	}
...
func TestServiceMonitor(t *testing.T) {
	...
	f := func(o opts) {
		t.Helper()
		ctx := context.TODO()
		got := ServiceMonitor(ctx, o.sm, &config.BaseOperatorConf{
...
func TestConvertPodEndpoints(t *testing.T) {
	...
	f := func(o opts) {
		t.Helper()
		ctx := context.TODO()
		assert.Equal(t, convertPodEndpoints(ctx, o.pe), o.want)
	}
...
func TestConvertProbe(t *testing.T) {
	...
	f := func(o opts) {
		t.Helper()
		ctx := context.TODO()
		got := Probe(ctx, o.pp, &config.BaseOperatorConf{
...
func TestPrometheusRule(t *testing.T) {
	...
	f := func(o opts) {
		t.Helper()
		ctx := context.TODO()
		got := PrometheusRule(ctx, o.pr, &config.BaseOperatorConf{
			FilterPrometheusConverterLabelPrefixes:      []string{"helm.sh"},
			FilterPrometheusConverterAnnotationPrefixes: []string{"app.kubernetes"},
		})
		assert.Equal(t, got, &o.want)
