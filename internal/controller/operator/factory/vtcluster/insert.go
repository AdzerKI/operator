...
func buildVTInsertPodSpec(cr *vmv1.VTCluster) (*corev1.PodTemplateSpec, error) {
	...
	ports = build.AddHTTPListenerPortsTo(ports, cr.Spec.Insert.HTTPListeners)
	...
	insertContainers := corev1.Container{
		Name:                     "vtinsert",
		Image:                    cr.Spec.Insert.Image.Reference(),
	...
	build.Lifecycle(&insertContainers, &cr.Spec.Insert.CommonAppsParams)
