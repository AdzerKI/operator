...
func createOrUpdateVPA(ctx context.Context, rclient client.Client, cr, prevCR *vmv1.VTSingle) error {
	if cr.Spec.VPA == nil {
		return nil
	}
...
func makePodSpec(r *vmv1.VTSingle) (*corev1.PodTemplateSpec, error) {
	...
	build.Lifecycle(&vtsingleContainer, &r.Spec.CommonAppsParams)
